...
// Resolve deps from the current working directory (typically the Next.js app
// root) so this script can be used via the web/ symlink without its own
// node_modules.
...
const { chromium } = (() => {
  try {
    ...
    return requireFromCwd('playwright-core');
  }
})();
